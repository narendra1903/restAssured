package ABC_016_JSONArrayDemo_Done;
...
public class JSON_Array1 {
	...
	public void JsonPathUsage() throws JsonParseException, JsonMappingException, IOException
	{
		...
		JSONArray jsonArray = new   JSONArray(j1.getList("books"));
		...
		System.out.println(jsonArray.getJSONObject(0).getString("isbn"));
		System.out.println(jsonArray.getJSONObject(0).getString("subtitle"));
		System.out.println(jsonArray.getJSONObject(0).getString("author"));
		System.out.println(jsonArray.getJSONObject(0).getString("published"));
		System.out.println(jsonArray.getJSONObject(0).getString("publisher"));
		System.out.println(jsonArray.getJSONObject(0).getInt("pages"));
		System.out.println(jsonArray.getJSONObject(0).getString("website"));
