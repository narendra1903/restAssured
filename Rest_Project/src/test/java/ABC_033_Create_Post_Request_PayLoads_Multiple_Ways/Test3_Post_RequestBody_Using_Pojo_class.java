...
public class Test3_Post_RequestBody_Using_Pojo_class {
	
  @Test
  public void Post_RequestBody_Using_Pojo_class( )
	{


	// JSON payload for the POST request
      JSONObject requestBody = new JSONObject();
      requestBody.put("name", "Harry Potter15");
      requestBody.put("gender", "Male");
      requestBody.put("email", "hoggwarts15@wiz.com");
