...
public class City4 
{
	...
	public void WeatherMessageBody()
	{
	 ...
	 Assert.assertEquals(body.contains("Hyderabad"), true , "Response body contains Hyderabad");
	 Assert.assertEquals(body.toLowerCase().contains("hyderabad") , true ,"Response body contains Hyderabad");
