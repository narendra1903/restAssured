...
public class List_MapContains_String_Object3 
{
	...
	public void WeatherMessageBody()
	{
	 ...
	 List<Map<String, Object>> Employee =   j1.given(JSON).getList("data"); 
		...
		for (Map<String, Object> E1 : Employee) {
			...
			System.out.println("email : "+E1.get("email"));
			System.out.println("first_name : "+E1.get("first_name"));
			System.out.println("last_name : "+E1.get("last_name"));
			System.out.println("avatar : "+E1.get("avatar"));
