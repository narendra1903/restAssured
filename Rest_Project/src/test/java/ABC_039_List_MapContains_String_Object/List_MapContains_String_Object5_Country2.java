...
public class List_MapContains_String_Object5_Country2 
{
	...
	public void Test1()
	{
	 ...
	 List<Map<String,Object>> T1=j1.getList("Countries");
		
	 for(int i=0;i<T1.size();i++)
	 {
	 System.out.println(T1.get(i).get("Country"));
	 System.out.println(T1.get(i).get("Data"));
