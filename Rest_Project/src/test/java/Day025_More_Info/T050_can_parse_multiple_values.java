...
public class T050_can_parse_multiple_values {
	...
	public void JsonPathUsage() throws JsonParseException, JsonMappingException, IOException
	{
		...
		final String category1 = j1.getString("store.book.category[0]");
        final String category2 = j1.getString("store.book.category[1]");
