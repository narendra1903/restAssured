...
public class T001_getList {
	...
	public void JsonPathUsage() throws JsonParseException, JsonMappingException, IOException
	{
		...
		List<String> categories = j1.getList("store.book.category");
		    
		Set<String> uniquecategories=new LinkedHashSet<String>();
		
		for(String str1 : categories)
		{
			//System.out.println("Book: " + str1);
			uniquecategories.add(str1);
		}
		
		System.out.println("All categories List is "+categories);
		System.out.println("uniquecategories set is "+uniquecategories);
