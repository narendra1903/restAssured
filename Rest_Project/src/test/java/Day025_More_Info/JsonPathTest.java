...
public class JsonPathTest {
    ...
    @Test
    public void T005_booksBetween5And15() {
    ...
    @Test
    public void T008_getFloatAndDoublesAsBigDecimal() {
    ...
    @Test
    public void T009_getFloatAndDoublesAsBigDecimalUsingStaticConfiguration() {
    ...
    @Test
    public void T010_nonStaticJsonPathConfigHasPrecedenceOverStaticConfiguration() {
    ...
    @Test
    public void T011_getRootObjectAsMap2() {
    ...
    @Test
    public void T013_rootPathFollowedByArrayIndexing() {
        final JsonPath jsonPath = new JsonPath(JSON).setRootPath("store.book");
        assertThat(jsonPath.getString("[0].author"), equalTo("Nigel Rees"));
    }

    @Test
    public void T014_supportsGettingEntireObjectGraphUsingEmptyString() {
        final List<Map<String, String>> object = JsonPath.from(JSON2).get("");
        assertThat(object.get(0).get("email"), equalTo("name1@mail.com"));
    }

    @Test
    public void T015_supportsGettingEntireObjectGraphUsing$() {
        final List<Map<String, String>> object = JsonPath.from(JSON2).get("$");
        assertThat(object.get(0).get("email"), equalTo("name1@mail.com"));
    }

    @Test
    public void T016_supportsGettingEntireObjectGraphUsingNoArgumentGet() {
        final List<Map<String, String>> object = JsonPath.from(JSON2).get();
        assertThat(object.get(0).get("email"), equalTo("name1@mail.com"));
    }

    @Test
    public void T017_getValueFromUnnamedRootObject() {
        final Map<String, String> object = JsonPath.from(JSON2).get("get(0)");
        assertThat(object.get("email"), equalTo("name1@mail.com"));
    }

    @Test
    public void T018_getValueFromUnnamedRootObjectUsingBrackets() {
        final Map<String, String> object = JsonPath.from(JSON2).get("[0]");
        assertThat(object.get("email"), equalTo("name1@mail.com"));
    }

    @Test
    public void T019_getSubValueFromUnnamedRootObjectUsingBrackets() {
        final String object = JsonPath.from(JSON2).getString("[0].email");
        assertThat(object, equalTo("name1@mail.com"));
    }

    @Test
    public void T020_getNumericalValues() {
    ...
    @Test
    public void T021_convertsValueToStringWhenExplicitlyRequested() {
    ...
    @Test
    public void T022_convertsValueToIntWhenExplicitlyRequested() {
    ...
    @Test
    public void T023_convertsValueToDoubleWhenExplicitlyRequested() {
    ...
    @Test
    public void T024_convertsValueToFloatWhenExplicitlyRequested() {
    ...
    @Test
    public void T025_convertsValueToUUIDWhenExplicitlyRequested() {
    ...
    @Test
    public void T026_convertsListMembersToDefinedTypeIfPossible() {
    ...
    @Test
    public void T027_getMapWithGenericType() {
    ...
    @Test
    public void T028_getMapWithAnotherGenericType() {
    ...
    @Test
    public void T029_getStringConvertsTheResultToAString() {
    ...
    public void T030_malformedJson() {
        JsonPath.from(MALFORMED_JSON).get("a");
    }

    @Test
    public void T031_getObjectWorksWhenPathPointsToAJsonObject() {
    ...
    @Test
    public void T032_getObjectWorksWhenPathPointsToATypeRefMap() {
    ...
    @Test
    public void T033_getObjectWorksWhenPathPointsToATypeRefList() {
    ...
    @Test
    public void T034_getObjectWorksWhenPathPointsToAJsonObject2() {
    ...
    @Test
    public void T035_getObjectAsMapWorksWhenPathPointsToAJsonObject() {
    ...
    @Test
    public void T036_getObjectWorksWhenPathPointsToAList() {
    ...
    @Test
    public void T037_getObjectAsFloatWorksWhenPathPointsToAFloat() {
    ...
    @Test
    public void T038_getObjectAsStringWorksWhenPathPointsToAString() {
        final String category = JsonPath.from(JSON).
        		getObject("store.book.category[0]", String.class);

        assertThat(category, equalTo("reference"));
    }

    @Test
    public void T039_jsonPathSupportsPrettifiyingJson() {
    ...
    @Test
    public void T040_jsonPathSupportsPrettyPrintingJson() {
    ...
    @Test
    public void T041_jsonPathSupportsPrettyPeekingJson() {
    ...
    @Test
    public void T042_jsonPathSupportsPeekingAtTheJson() {
    ...
    @Test
    public void T043_canParseJsonDocumentWhenFirstKeyIsIntegerUsingManualEscaping() {
    ...
    @Test
    public void T044_canParseJsonDocumentWhenFirstKeyThatIsAIntegerUsingNoEscaping() {
        final float number = JsonPath.from(JSON_PATH_STARTING_WITH_NUMBER).getFloat("0");
    ...
    @Test
    public void T045_canParseJsonDocumentWhenPathIncludesKeyThatIsAIntegerUsingNoEscaping() {
    ...
    @Test
    public void T046_canParseJsonDocumentWhenPathIncludesKeyThatIsABooleanUsingEscaping() {
    ...
    @Test
    public void T047_canParseJsonDocumentWhenPathIncludesKeyThatIsABooleanUsingNoEscaping() {
    ...
    @Test
    public void T048_canParseJsonDocumentWhenPathIncludesMinusInsideEscaped() {
     ...
     */
    @Test
    public void T049_canParseJsonDocumentWithMultipleConsecutiveIntegersInsidePath() {
        String json = "{\n" +
                "    \"foo.bar.baz\": {\n" +
                "        \"0.2.0\": \"test\"\n" +
                "    }\n" +
    ...
    @Test
    public void T050_can_parse_multiple_values() {
        // Given
    ...
    @Test
    public void T051_pretty_printing_works() {
        // Given
        String json = "{\"data\": [{" +
                "         \"uid\": 10,\n" +
                "         \"name\": \"abc\"\n" +
    ...
    @Test
    public void T052_parses_json_document_with_attribute_name_equal_to_properties() {
        // Given
    ...
    @Test
    public void T053_parses_json_document_with_attribute_name_equal_to_size() {
        // When
    ...
    @Test public void T054_can_find_if_a_key_exists_in_json_object() {
        // Given
        String json = "{\n" +
                "\"status\": \"success\",\n" +
                "\"fund_code\":\"00200\",\n" +
    ...
    @Test public void T055_can_parse_json_attributes_starting_with_a_number() {
        // Given
        String json = "{\n" +
    ...
    @Test public void T056_automatically_escapes_json_attributes_whose_name_equals_properties() {
        // Given
        String json = "{\n" +
                "   \"features\":[\n" +
                "      {\n" +
    ...
    @Test public void T057_can_manually_escape_class_property() {
        // Given
        String json = "{\n" +
                "  \"semester\": \"Fall 2015\",\n" +
                "  \"groups\": [\n" +
    ...
    @Test public void T058_automatically_escapes_class_property() {
        // Given
        String json = "{\n" +
                "  \"semester\": \"Fall 2015\",\n" +
                "  \"groups\": [\n" +
     ...
     */
    @Test public void T059_unicode_json_values_are_pretty_printed_without_unicode_escaping() {
        final String prettyJson = JsonPath.with("{\"some\":\"ŘÍŠŽŤČÝŮŇÚĚĎÁÉÓ\"}").prettyPrint();

        assertThat(prettyJson, equalTo("{\n    \"some\": \"ŘÍŠŽŤČÝŮŇÚĚĎÁÉÓ\"\n}"));
    }

    @Test public void TC060_need_to_escape_lists_with_hyphen_and_brackets() {
        // Given
    ...
    @Test public void TC061_doesnt_need_to_escape_lists_with_hyphen_without_brackets() {
        // Given
    ...
    /** Tests #1543 is fixed    */
    @Test public void TC062_does_not_fail_on_absent_lists() {
        // Given
        String json = "{ \"root\" : { } }";
